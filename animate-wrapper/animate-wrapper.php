<?php
/**
 * Plugin Name:       Animate Wrapper
 * Description:       Wrap content in AOS animation
 * Version:           0.1.0
 ...
 */
function fwd_blocks_animate_wrapper_block_init() {
...
add_action( 'init', 'fwd_blocks_animate_wrapper_block_init' );
