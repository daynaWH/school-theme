...
<main class="wp-block-group"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/drawing-wireframes-1.jpg","alt":"a woman drawing wireframes","dimRatio":70,"overlayColor":"contrast","isUserOverlayColor":true,"focalPoint":{"x":0.49,"y":0.51},"align":"wide","style":{"spacing":{"margin":{"top":"0"}}},"layout":{"type":"default"}} -->
